...
def penalty_g(theta):
    ...
    return lambda_reg * off_diag_part + mu_reg * np.sum(diag_part)
...
# Test des fonctions
theta_sample = np.copy(theta_true)  # Exemple d'initialisation
g_val = penalty_g(theta_sample)
f_val = log_likelihood_penalized(theta_sample, Y)

print(g_val, f_val)  # Vérification des valeurs des fonctions
